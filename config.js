...
window.PORTFOLIO_CONFIG = {
  ...
  works: [
    { category:"ai", orientation:"landscape", poster:"ai-cinematic-01", title:"Cinematic AI Music Video", foot:"reel_001 · text-to-video", video:"https://youtu.be/xtJId7RjkWM", alt:"Cinematic AI short — moody office scene rendered entirely with AI tools", process:"script + shot list → text-to-video generations, style-matched shot by shot → assembled, graded and sound-designed in Premiere Pro. Every frame generated; every cut human." },
    { category:"ai", orientation:"landscape", poster:"ai-cinematic-02", title:"Cinematic AI Short — From Scratch", foot:"reel_002 · text-to-video", video:"https://youtu.be/KSdsuyZ9HKw", alt:"Cinematic AI short — moody office scene rendered entirely with AI tools", process:"script + shot list → text-to-video generations, style-matched shot by shot → assembled, graded and sound-designed in Premiere Pro. Every frame generated; every cut human." },
    { category:"ai", orientation:"landscape", poster:"ai-cinematic-03", title:"Cinematic Motion Launch Trailer", foot:"reel_003 · text-to-video", video:"https://youtu.be/fUZPP5u9S-I", alt:"Cinematic AI short — moody office scene rendered entirely with AI tools", process:"script + shot list → text-to-video generations, style-matched shot by shot → assembled, graded and sound-designed in Premiere Pro. Every frame generated; every cut human." },
